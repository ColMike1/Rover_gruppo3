...
/* Named constants for Chart: '<S4>/Check rover safety state' */
#define Supervi_IN_Rover_Critical_State ((uint8_T)1U)
#define Supervi_IN_Rover_Degraded_State ((uint8_T)2U)

/* Named constants for Chart: '<S4>/Check rover safety state1' */
...
void SupervisorB2_step(void)
{
  ...
  if (SupervisorB2_Y.autorized_to_send_command) {
    ...
    /* End of Chart: '<S4>/Generate Fallback Decision' */
    ...
    /* End of Chart: '<S4>/Check rover safety state1' */
  }
