...
/* Named constants for Chart: '<Root>/Check rover safety state1' */
...
void SupervisorB1_step(void)
{
  ...
  real32_T omega_user;
  uint32_T qY;
  boolean_T motorFaultDetected[4];
     ...
     case SupervisorB1_IN_Retromarcia_180:
      ...
      if (SupervisorB1_DW.done180) {
        ...
        angle_err = SupervisorB1_angleError
          (SupervisorB1_U.Board2_Data.payload.yaw, SupervisorB1_Y.target_angle);
