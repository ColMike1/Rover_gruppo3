...
void Sabertooth_Init(void)
{
    ...
    Prepare_Saber_Packet(&saber_tx[0U], SABER_BACK_ADDR, SABER_INIT_CMD, SABER_INIT_VALUE);
    Prepare_Saber_Packet(&saber_tx[SABER_PACKET_LEN], SABER_FRONT_ADDR, SABER_INIT_CMD, SABER_INIT_VALUE);
