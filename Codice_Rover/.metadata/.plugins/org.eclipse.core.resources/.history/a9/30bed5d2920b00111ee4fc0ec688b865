...
/* Named constants for Chart: '<S12>/SuperB2_DEGB1_1' */
...
#define SupervisorB2_IN_Step2          ((uint8_T)1U)
#define SupervisorB2_IN_Step3          ((uint8_T)2U)
#define SupervisorB2_IN_Step4          ((uint8_T)3U)

/* Named constants for Chart: '<Root>/Check for B1 failure' */
#define Supervi_IN_B2_trying_to_actuate ((uint8_T)2U)
#define SupervisorB2_IN_B1_actuating   ((uint8_T)1U)

/* Named constants for Chart: '<S14>/SuperB2_DEGB1_0' */
...
PrevZCX_SupervisorB2_T SupervisorB2_PrevZCX;
...
void SupervisorB2_step(void)
{
  ...
  if (SupervisorB2_Y.autorized_to_send_command) {
    ...
    if (SupervisorB2_DW.is_active_c5_SupervisorB2 == 0) {
      ...
      /* End of Outputs for SubSystem: '<S10>/superB2_DEGB1_1' */
    }

    /* End of Chart: '<S1>/Generate B2 Decision' */
  ...
  /* End of Outputs for SubSystem: '<Root>/Actuation decision and motion state' */
  ...
  /* End of MATLAB Function: '<Root>/Imu-odometry coherence' */
