...
\begin{itemize}
    \item \textbf{Modalità degradata}: il sistema mantiene la funzionalità ma con prestazioni o capacità ridotte.
    \item \textbf{Modalità critica}: il sistema si blocca, interrompendo l'esecuzione dei comandi utente per motivi di sicurezza o impossibilità tecnica.
\end{itemize}
\paragraph{Meccanismo di rilevazione dei guasti}
Il passaggio a queste modalità avviene monitorando l'intervallo di tempo tra due letture \textit{corrette} da sensori o periferiche. Ogni Board legge i propri sensori e considera la lettura "corretta" quando la funzione software dedicata 
