...
In condizioni di funzionamento nominale la Board 1 si occupa di gestire l'attuazione dei motori, inviando tramite UART l'ingresso di controllo ai motori. Questi possono raggiungere una velocità massima di $160 RPM$.
...
Questi riferimenti sono influenzati da condizioni di sicurezza quali la presenza di ostacoli statici o in movimento o anomalie rilevate dai supervisori.
...
di deviazione o di aggiramento. Questi comandi vengono inviati alla Board 1 tramite la comunicazione UART, che si occupa di eseguirli se non sono presenti fault critici o degradati.

In seguito si mostrranno le condizioni di funzionamento in presenza di fault.

\subsection{Encoder non funzionanti}
\begin{figure}[H]
    \centering
