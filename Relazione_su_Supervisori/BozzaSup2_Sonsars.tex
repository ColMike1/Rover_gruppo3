...
\begin{longtable}{ll p{5cm}} 
    \caption{Mappatura della maschera di errore a 8 bit} \label{tab:fault_mapping_table} \\
    \hline
    ...
    \textbf{wheel\_status(i)}  & WHEEL\_DEGRADED\_ENCODER & Quando viene dato un riferimento di velocità ma gli rpm sono nulli per un periodo di tempo, considerando l'inerzia delle ruote. Questa condizione è rilevata da $has\_no\_feedback(i)$. \\
       ...
       \\ & WHEEL\_OK & Quando non ci sono ne condizioni critiche ne degradate\\ \hline
    
    \textbf{b2\_sup\_status} & SUP\_DEGRADED & Description for degraded status \\ 
    & SUP\_CRITICAL & Description for critical status \\ \hline
...
\begin{figure}[H]
    ...
    \caption{Chart per la costruzione delle maschere di errore critiche e degradate.}
